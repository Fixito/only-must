  ...
  return (
    <form className="me-2 grid w-full max-w-lg lg:max-w-sm" onSubmit={handleSubmit}>
      ...
      <input
        ...
        id="search"
        placeholder="Search"
        className="placeholder:text-muted-foreground text-navbar-primary-foreground focus-visible:outline-ring outline-navbar-border bg-navbar-accent col-start-1 row-start-1 block w-full rounded-md py-1.5 ps-3 pe-10 text-base outline -outline-offset-1 focus-visible:outline-2 focus-visible:-outline-offset-1 sm:text-sm"
        value={searchInput}
